        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6">
              ...
              <a
                href={`tel:${contacts.phone1}`}
                className="block font-display text-2xl font-bold text-white hover:text-accent-500 transition mb-2"
              >
              ...
              <a
                ...
                className="block font-display text-2xl font-bold text-white hover:text-accent-500 transition mb-3"
              >
